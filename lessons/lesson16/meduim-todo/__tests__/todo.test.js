import { createTodo, addTodo, countTodos, exportTitles, firstTodoTitle, lastTodoTitle } from "../src/js/todo.js";
...
describe('addTodo', () => {
	it('should add a todo to the list of todos', () => {
		...
		expect(updatedTodos).toEqual([{ title: 'Take a walk' }, { title: 'Write code' }]);
	});
});
...
describe('exportTitles', () => {
	it('should return an array of todo titles', () => {
		const todos = [{ title: 'Take a walk' }, { title: 'Write code' }];
